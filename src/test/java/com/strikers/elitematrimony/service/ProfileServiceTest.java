...
public class ProfileServiceTest {
	...
	@Test
	public void testSuggestedList() {
		Mockito.when(profileRepository.getSuggestedProfileList(1, "Female", StringConstant.NOT_INTERESTED_STATUS))
				.thenReturn(profiles);
		profileServiceImpl.suggestedList(suggestedListRequestDto);
		assertEquals(1, suggestedListResponseDtos.size());
	}
